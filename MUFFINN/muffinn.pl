#!/usr/bin/perl -w
#<muffinn.pl: Run MUFFINN with HumanNet and String v10.0>
...
my $command = "";
foreach my $nw (@nw_arr){
	print "\n$nw ...\n";
	my $nw_file = "./backend/nw/".$nw;
	foreach my $method (@method_arr){
		print "\t\t$method ...\n";

##### Do MUFFINN
		my $output_file = "./output/".$method."_".$tag.".".$nw;
